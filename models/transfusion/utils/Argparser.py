...
def get_argparser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="mvtec3d",
        choices=["mvtec3d", "mvtec", "visa", "adam3d"],
    )
    parser.add_argument(
    ...
    parser.add_argument("--dtd-path", type=str, default="./datasets/dtd/images/")
    parser.add_argument(
    ...
    parser.add_argument("--epoch-num", type=int, default= 1501)#1501)
